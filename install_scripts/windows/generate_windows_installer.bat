...
set GTKDir=C:\GTK
set NmapDir="C:\Program Files\Nmap"
set WinpcapDir="C:\Program Files\Winpcap"
...
mkdir %DistDir%\share\themes\Emacs
mkdir %DistDir%\share\themes\Raleigh
...
xcopy %GTKDir%\share\themes\Emacs\*.* %DistDir%\share\themes\Emacs /S >> %Output%
xcopy %GTKDir%\share\themes\Raleigh\*.* %DistDir%\share\themes\Raleigh /S >> %Output%

xcopy %GTKDir%\share\xml\*.* %DistDir%\share\xml\ /S >> %Output%
echo Let's copy all dlls under C:\Gtk\bin\
copy %GTKDir%\bin\*.dll %DistDir% >> %Output% 
